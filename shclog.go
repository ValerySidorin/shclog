...
const SlogLevelTrace = slog.LevelDebug - 1
...
func (l *Shclog) Trace(msg string, args ...interface{}) {
	l.l.Log(context.Background(), SlogLevelTrace, l.namePrefix+msg, args...)
}

func (l *Shclog) Debug(msg string, args ...interface{}) {
	l.l.Debug(l.namePrefix+msg, args...)
}

func (l *Shclog) Info(msg string, args ...interface{}) {
	l.l.Info(l.namePrefix+msg, args...)
}

func (l *Shclog) Warn(msg string, args ...interface{}) {
	l.l.Warn(l.namePrefix+msg, args...)
}

func (l *Shclog) Error(msg string, args ...interface{}) {
	l.l.Error(l.namePrefix+msg, args...)
}
...
func (l *Shclog) Name() string {
	...
	return l.namePrefix[:len(l.namePrefix)-2]
}
